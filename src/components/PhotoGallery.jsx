...
export default function PhotoGallery({ photos }) {
    ...
    const frameStyles = [
        "border-[12px] border-cyan-300 rounded-lg rotate-2 shadow-xl",
        "border-[12px] border-sky-300 rounded-lg -rotate-3 shadow-xl",
        "border-[12px] border-cyan-200 rounded-lg rotate-1 shadow-xl",
        "border-[12px] border-sky-200 rounded-lg -rotate-2 shadow-xl",
        "border-[12px] border-cyan-300 rounded-lg rotate-3 shadow-xl",
        "border-[12px] border-sky-300 rounded-lg -rotate-1 shadow-xl",
    ]
    ...
    return (
        ...
        >
            ...
            <motion.h2
                ...
                className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 via-sky-500 to-cyan-500 text-center mb-12 animate-gradient"
            >
            ...
            <motion.div className="flex flex-wrap justify-center gap-10 md:gap-12" >
                {photos.map((photo, index) => (
                    ...
                    >
                        ...
                        >
                            <span className="text-sm text-cyan-600 whitespace-nowrap">{photo.alt}</span>
                        </motion.div>

                        {/* Decorative tape */}
                        <div className="absolute -top-3 left-1/4 w-10 h-6 bg-cyan-200/80 rotate-12 rounded-sm"></div>
                        <div className="absolute -top-3 right-1/4 w-10 h-6 bg-sky-200/80 -rotate-12 rounded-sm"></div>
                    </motion.div>
                ))}
            </motion.div>
                ...
                {selectedPhoto && (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <p className="text-lg font-medium text-cyan-600 bg-white/80 mx-auto py-2 px-4 rounded-full inline-block">
                                    {selectedPhoto.alt}
                                </p>
                            </motion.div> */}
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.9 }}
                                className="absolute top-2 right-2 bg-cyan-500 text-white rounded-full w-8 h-8 flex items-center justify-center cursor-pointer"
                                onClick={() => setSelectedPhoto(null)}
                            >
                                <XIcon />
                            </motion.button>
